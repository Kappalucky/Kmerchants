<template>
  <div class="mx-auto my-16 container">
    <h1 class="text-2xl headers text-mono mb-4 tracking-widest">
      Profile
    </h1>
...
export default {
  ...
  mounted() {
    ...
    this.address = Object.assign({}, this.userProfile.address);

    this.miscellaneous = Object.assign({}, this.userProfile.miscellaneous);
  },
  destroyed() {
    this.identity = {
      fullName: '',
